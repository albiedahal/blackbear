 ...
 */
class ModifiedMazarsDamage : public ScalarDamageBase, public GuaranteeConsumer
{
public:
  static InputParameters validParams();
  ModifiedMazarsDamage(const InputParameters & parameters);
